              ...
              <>
                <div className="mb-6">
                  ...
                  <p className="text-xs text-gray-400">
                    Identificamos os gargalos do seu ciclo de receita em 30 minutos.
                  </p>
                </div>
...
const differentials = [
  {
    ...
    desc: 'Não abrimos chamado e aguardamos. Entendemos o fluxo de receita, as regras das operadoras e como o MV deve ser configurado para cada realidade. É isso que nos diferencia de TI básico.',
  },
  {
    num: '02',
    title: 'Resultado definido antes de começar',
    desc: 'Toda entrega é acordada com indicador de sucesso. Você sabe o que está contratando, como será medido e qual é o critério de conclusão.',
  },
  {
    num: '03',
      ...
      <div className="grid md:grid-cols-[1fr_2fr] gap-12 lg:gap-20 items-start">
        ...
        <div className="md:sticky md:top-28">
          ...
          <p className="text-sm text-white/60 leading-relaxed">
            Existe suporte de TI. E existe consultoria que usa o sistema como alavanca de resultado financeiro.
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div>
            ...
            <h2 className="font-title text-3xl md:text-4xl font-bold text-primary leading-tight mb-5">
              30 minutos para identificar onde sua receita está vazando.
            </h2>
            <p className="text-sm text-gray-500 leading-relaxed mb-8">
              Um especialista analisa seu ciclo de receita, mapeia os principais gargalos
              e indica o que pode ser corrigido no seu sistema MV agora.
            ...
            <ul className="space-y-4">
              {[
                ...
                ['Resultado concreto', 'Você sai da reunião com 3 gargalos identificados e priorizados.'],
              ].map(([label, detail]) => (
